...
export default function sitemap(): MetadataRoute.Sitemap {
  const staticPages: MetadataRoute.Sitemap = [
    ...
    { url: `${BASE}/ar/youtube-earnings-tunisia`, lastModified: new Date(), changeFrequency: "monthly", priority: 0.7 },
    { url: `${BASE}/ar/ارباح-اليوتيوب-في-تونس`, lastModified: new Date(), changeFrequency: "monthly", priority: 0.7 },
    { url: `${BASE}/ar/youtube-earnings-jordan`, lastModified: new Date(), changeFrequency: "monthly", priority: 0.7 },
    { url: `${BASE}/ar/ارباح-اليوتيوب-في-الاردن`, lastModified: new Date(), changeFrequency: "monthly", priority: 0.7 },
    { url: `${BASE}/ar/youtube-earnings-libya`, lastModified: new Date(), changeFrequency: "monthly", priority: 0.7 },
    { url: `${BASE}/ar/ارباح-اليوتيوب-في-ليبيا`, lastModified: new Date(), changeFrequency: "monthly", priority: 0.7 },
    { url: `${BASE}/ar/youtube-earnings-qatar`, lastModified: new Date(), changeFrequency: "monthly", priority: 0.7 },
    { url: `${BASE}/ar/ارباح-اليوتيوب-في-قطر`, lastModified: new Date(), changeFrequency: "monthly", priority: 0.7 },
    // Legal / utility
